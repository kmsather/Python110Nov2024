...
# Desc: Shows how to work with exceptions and share to GitHub
# Change Log: (Who, When, What)
# Katherine Sather, 11/10/2024 Created script
# ------------------------------------------------------------------------------------------ #

#add code to import json file
import json
...
#Add code that opens the json file, dumps the data into the students table variable and closes the file.
#Add a try statement
